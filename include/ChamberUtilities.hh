...
// General variables used in the following methods
...
// Changed mm_eff from a vector of length 8 (Planes) to one of length 64 (PCB Left/Right of each Plane)
// Returns a vector of length 64 with a 1 where a hit occured and a 0 where one did not
